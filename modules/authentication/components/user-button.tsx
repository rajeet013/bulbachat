...
export default function UserButton({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className={`relative ${avatarSizes[size]} rounded-full cursor-pointer outline-none`}>
        ...
        {showBadge && (
          <Badge variant={badgeVariant} className="absolute -bottom-1 -right-1 h-5 px-1 text-xs">
            {badgeText}
          </Badge>
        )}
      </DropdownMenuTrigger>
