                            ...
                            filteredModels.length === 0 ? (
                                ...
                                filteredModels.map((model) => (
                                    <div 
                                        key={model.id}
                                        className={cn(
                                            "relative flex cursor-pointer select-none items-start gap-2 rounded-md p-2 text-sm outline-none transition-colors hover:bg-accent hover:text-accent-foreground",
                                    ...
                                    >
                                        ...
                                        <Button variant="ghost" size="sm" className="h-6 w-6 p-0 shrink-0" onClick={(e) => openModelDetails(model, e)}>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-sm font-medium">
                                    {formatContextLength(selectedForDetails.context_length ?? 0)} tokens
                                </p>
                            </div>
                            <div className="space-y-1">
                    ...
                    <div>
                        ...
                        {isFreeModel(selectedForDetails) ? (
                            <div className="flex items-center gap-2 p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                                <Badge variant="secondary" className="bg-green-500/20">FREE</Badge>
